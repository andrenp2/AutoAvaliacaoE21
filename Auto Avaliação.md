...
Durante o curso, consegui acompanhar e tirar o melhor proveito das aulas. Foi meu primeiro contato com o "frontend" e com as linaguens: html,javascript e css. Mesmo assim realizei todas as atividades como o esperado e fui além do que foi proposto. Sobre comportamento pessoal, me destaquei principalmente na resiliencia, onde alguns projetos mais elaborados tive que refazer algumas vezes até atingir o esperado, e consegui levar até o final.
      
         

- **Pontos de melhoria**  

Como melhoria, desejo me aprofundar mais nas documentações para diversificar alguns métodos e aprender novos jeitos de codificar, utilizar funções e soluções mais sofisticadas.    
...
O curso como um todo nos desenvolveu em todos os aspectos. Desde organização, onde utilizando o github para organizar as atividades, projetos e aulas. A questão de pro atividade, de ir atrás de soluções dos problemas, tirar dúvidas e saber onde buscar novos conhecimentos. E toda a parte técnica na prática dos exercícios.
...
1. Você já sabia programar, se sim, quais linguagens? 
    ...
    Sim. Tive experiência em Python e Linguagem C. (Aplicados para resolução de equações e problema de engenharia)
...
3. Você já teve alguma experiencia profissional em alguma empresa de desenvolvimento de software, se sim, conte um pouco a respeito.
    ...
    Realizei um estágio na área comercial em uma empresa de software.


4. Você está trabalhando atualmente, conte um pouco a respeito?

    Atualmente, estou em período de experiencia como Desenvolvedor Junior em C++, para uma empresa de software para engenharia. 

5. Você está estudando atualmente (ensino médio, superior, outros...)?  

    Estou no último período do curso superior bacharelado em Engenharia de Petróleo.
